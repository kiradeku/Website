...
class AnketaForm (forms.Form):
    ...
    notice = forms.BooleanField (label = 'Получать новости о новинка на e-mail ? ' , required=False)
    email = forms.EmailField (label = 'Ваше e-mail' , min_length=7)
    message = forms.CharField (label = 'Отзыв' , widget=forms.Textarea(attrs={'rows':12 ,'cols':20}))
